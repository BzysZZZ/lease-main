...
import com.qianlou.admin.service.ApartmentInfoService;
...
import com.qianlou.model.enums.ReleaseStatus;
...
public class ApartmentController {
    ...
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current,
        ...
        IPage<ApartmentItemVo> list = apartmentInfoService.apartmentItemByQueryForPage(page, queryVo);
