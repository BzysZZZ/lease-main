package com.qianlou.app.controller.history;
...
public class BrowsingHistoryController {
    ...
    private Result<IPage<HistoryItemVo>> page(@RequestParam long current, @RequestParam long size) {
        ...
        IPage<HistoryItemVo> list = browsingHistoryService.pageHistoryItemByUserId(page, LoginUserContext.getLoginUser().getUserId());
